document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    function checkVisibility() {
      ...
      var triggerOffset = windowHeight * 0.88;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בטטיק של תומר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '963f1b8b-bd46-41ce-aaf5-77b160838312',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '963f1b8b-bd46-41ce-aaf5-77b160838312';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '963f1b8b-bd46-41ce-aaf5-77b160838312';
